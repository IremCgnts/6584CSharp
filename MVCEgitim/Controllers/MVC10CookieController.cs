...
namespace MVCEgitim.Controllers
{
    public class MVC10CookieController : Controller
    {
        ...
        public ActionResult CookieOku()
        {
            ...
            {
                TempData["kullaniciadi"] = HttpContext.Request.Cookies["username"].Value;// uygulamanın oluşturduğu cookie yi okuyup tempdata ile ekrana yplluyoruz.
             
            }
            return View();
        }
        public ActionResult CookiSil()
        {
            if (HttpContext.Request.Cookies["username"] != null)
            {
